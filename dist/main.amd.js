define("#plug-task#lib/task", ["require", "exports"], function(require, exports) {
    "use strict";
    var TASK_ID = 1;
...
define("#plug-task#lib/util", ["require", "exports", "#plug-task#lib/task"], function(require, exports, task_1) {
    "use strict";
    function warp(fn) {
        return function () {
...
define("#plug-task#lib/queue", ["require", "exports", "#plug-task#lib/task"], function(require, exports, task_2) {
    "use strict";
    class Queue {
        ...
        *put(value) {
            if (this.size > 0 && this.current >= this.size) {
                this.put_waits.push(task_2.self_id());
                yield task_2.suspend();
                this.queues.push(value);
                return this.current;
            }
            while (this.get_waits.length > 0) {
                let tid = this.get_waits.shift();
                let cur = task_2.get(tid);
                if (cur) {
        ...
        *get() {
            if (this.current <= 0) {
                this.get_waits.push(task_2.self_id());
                return yield task_2.suspend();
            }
...
define(["require", "exports", "#plug-task#lib/task", "#plug-task#lib/util", "#plug-task#lib/queue"], function(require, exports, task_3, util_1, queue_1) {
    "use strict";
    exports.run = task_3.run;
    exports.start = task_3.start;
    exports.self = task_3.self;
    exports.self_id = task_3.self_id;
    exports.join = task_3.join;
    exports.join_all = task_3.join_all;
    exports.sleep = task_3.sleep;
    exports.suspend = task_3.suspend;
    exports.get_data = task_3.get_data;
    exports.set_data = task_3.set_data;
...
//# sourceMappingURL=_maps/main.amd.js.map
